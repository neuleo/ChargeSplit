...
- **App Structure**: Single Activity (`MainActivity`) hosting composable screens (e.g., `ChargeSplitScreen` and `WearScreen`) navigated using a tab-based `HorizontalPager`.
